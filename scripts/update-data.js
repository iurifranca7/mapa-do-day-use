...
// CORREÇÃO: Permite ignorar campos undefined sem quebrar o script
...
const updateData = async () => {
  try {
    ...
    for (const item of updates) {
        ...
        // CORREÇÃO: Adicionados fallbacks (|| "") para evitar undefined
        const updatePayload = {
            description: item.description || currentData.description || "",
            priceAdult: item.priceAdult ? Number(item.priceAdult) : (currentData.priceAdult || 0),
